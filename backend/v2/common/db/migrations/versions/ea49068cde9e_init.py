...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_rdx_analyst_email'), 'rdx_analyst', ['email'], unique=False)
    op.create_index(op.f('ix_rdx_analyst_token'), 'rdx_analyst', ['token'], unique=False)
    op.create_table('rdx_user',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('email', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('token', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('token_expires_at', sa.DateTime(), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['data_steward_id'], ['rdx_user.id'], ),
    sa.ForeignKeyConstraint(['researcher_id'], ['rdx_user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_rdx_dataset_condtions_share_id'), 'rdx_dataset', ['condtions_share_id'], unique=False)
    op.create_index(op.f('ix_rdx_dataset_data_steward_id'), 'rdx_dataset', ['data_steward_id'], unique=False)
    op.create_index(op.f('ix_rdx_dataset_doi'), 'rdx_dataset', ['doi'], unique=False)
    op.create_index(op.f('ix_rdx_dataset_researcher_id'), 'rdx_dataset', ['researcher_id'], unique=False)
    op.create_index(op.f('ix_rdx_dataset_share_id'), 'rdx_dataset', ['share_id'], unique=False)
    op.create_table('rdx_share',
    sa.Column('share_id', sa.Integer(), nullable=False),
    sa.Column('path', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('uid_owner', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('additional_info_owner', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('permissions', sa.Integer(), nullable=False),
    sa.Column('rdx_dataset_id', sa.Integer(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['rdx_dataset_id'], ['rdx_dataset.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_rdx_share_share_id'), 'rdx_share', ['share_id'], unique=False)
